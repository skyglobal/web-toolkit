...
if (typeof window.define === "function" && window.define.amd) {
    define('utils/toggle', ['bower_components/bskyb-detect/dist/js/detect.requirejs','utils/event'], function(detect,event) {
        toolkit.toggle = toolkit.toggle(detect, event);
        return toolkit.toggle;
    });
} else {
    toolkit.toggle = toolkit.toggle(skyComponents.detect, toolkit.event);
}
