module.exports = {
    "dev-build": ['clean:toolkit', 'clean:dist', 'compass:toolkit', 'requirejs', 'uglify', 'jekyll:build', 'prepare-site'],
    ...
    //  misc tasks
    "fonts": ['clean:css', 'clean:fonts', 'svgmin:fonts', 'webfont', 'compass:toolkit', 'cssmin:skycons'],
